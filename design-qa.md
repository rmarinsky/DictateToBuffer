...
- Implementation: `/Applications/Diduny TEST.app`, clean TEST state.
...
- [P0] Visual evidence is unavailable.
  ...
  - Evidence: the TEST app is installed and launches, but the Mac is locked, so no implementation screenshot or interaction capture is available.
